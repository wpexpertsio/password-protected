...
class Password_Protected_Admin_Debug {
	...
	public function section_debugging() {
		...
		echo '<p>' . __( 'This panel will try to log what happens when a user enters the password on the frontend of the website.', 'password-protected' ) . '<br />
			...
			<p><textarea rows="8" style="width: 100%" placeholder="' . esc_attr__( 'No information logged yet. Please try entering the password on the frontend of the website and check back here for information.', 'password-protected' ) . '"></textarea></p>';
